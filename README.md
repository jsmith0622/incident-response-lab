...
| Component | Details |
|---|---|
| SIEM Host & Victim | Ubuntu 26.04 ARM64 running Elasticsearch, Kibana, Elastic Agent (also the compromised SSH target) |
...
| Privilege Escalation | Backdoor accounts added to sudo group | T1548 |
...
- **Lessons Learned:** Root cause identified as weak password and no host firewall. 7 hardening recommendations documented
...
I used Claude (Anthropic) as a tool throughout this lab, the same way I use it across the series. It helped me walk through each phase of the response, deepen my understanding of the attacker's actions and the containment steps as I worked, and document what I did along the way. I directed the investigation, made the response decisions, and ran every containment, eradication, and recovery action myself, verifying each command and result independently.
